...
public class RecordsFile extends BaseRecordsFile {
     ...
     * efficiency.
     */
    public RecordsFile(String dbPath, int initialSize) throws IOException, IOException {
     ...
     */
    protected RecordHeader allocateRecord(String key, int dataLength) throws IOException, IOException {
